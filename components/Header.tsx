...
<div className="max-w-7xl mx-auto">
  <div className="text-center mb-2 flex flex-col items-center justify-center gap-2">
    ...
    <div className="flex items-center gap-3">
      <a
        href="https://www.kasraeminence.com"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-block"
      >
        <img
          src="https://www.kasraeminence.com/wp-content/uploads/2025/08/logo۱e-scaled.png"
          alt="لوگو امیننس"
          className="w-12 h-12 md:w-16 md:h-16 object-contain cursor-pointer transform transition-transform duration-300 hover:scale-110 active:scale-95"
        />
      </a>

      <h1 className="text-base md:text-3xl font-extrabold text-brand-gray-light tracking-tight">
